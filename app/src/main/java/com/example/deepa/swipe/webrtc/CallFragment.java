...
public class CallFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        backimage = controlView.findViewById(R.id.idbackcamera);

        RelativeLayout rltlayout = (RelativeLayout)controlView.findViewById(R.id.idrelativelayout);
        rltlayout.setOnTouchListener(new OnSwipeTouchListener(getActivity()) {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                callEvents.onCallHangUp();
                getActivity().finish();
              //  startActivity(new Intent(getActivity(),DisplayFilteruserActivity.class));
